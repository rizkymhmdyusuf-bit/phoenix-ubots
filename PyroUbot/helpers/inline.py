...
class BTN:
    ...
    def PROMODEK(message):
        button = [
            [InlineKeyboardButton("「 ✅ Setuju & Lanjutkan 」", url="http://t.me/RitzV55?text=Bang+Mau+Beli+Reseller+Ubot+Kirim+Qris+Atau+Dana")],
        ]
        return button

    def ALWAYSBOYSZ(message):
        button = [
            [InlineKeyboardButton("room public", url="https://t.me/RitzPBC")],
        ]
        return button
    ...
    def START(message):
        if not message.from_user.id == OWNER_ID:
            button = [
                ...
                [
                    InlineKeyboardButton("✭ ʀᴏᴏᴍ ᴘᴜʙʟɪᴄ ✭", url="https://t.me/RitzPBC"),
                    InlineKeyboardButton("⦪ sᴜᴘᴘᴏʀᴛ ✭", url="https://t.me/BuyerUserbot")
                ],
                [
                    InlineKeyboardButton("⦪ ᴀʙᴏᴜᴛ ✭", url="https://t.me/AboutRitz")
                ],
                [
